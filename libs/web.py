...
from bottle import run, route, post, response, request, redirect, template
...
def page():
    ...
    return template(os.path.join(get_script_path(), 'resources', 'templates', 'form.tpl'), message = message)
